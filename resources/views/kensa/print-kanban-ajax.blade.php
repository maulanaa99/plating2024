...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="input-group">
            <input type="number" id="kirim_assy" name="kirim_assy" class="form-control" onkeyup="sum();" maxlength="3"
                required>
            <div class="input-group-prepend">
                <span class="input-group-text">Pcs </span>
            </div>
    ...
    <div class="col-md-4">
        ...
        <div class="input-group">
            <input type="text" id="kirim_ppic" name="kirim_ppic" class="form-control" onkeyup="sum();" maxlength="3"
                required>
            <div class="input-group-prepend">
                <span class="input-group-text">Pcs </span>
            </div>
    ...
    <div class="col-md-4">
        <label>PIC Packing <i class="fas fa-search-plus"></i></label>
        <div class="input-group">
            <input type="text" id="pic_packing" name="pic_packing" class="form-control" required>
        </div>
    </div>
    <input type="hidden" id="kirim_assy" name="kirim_assy" class="form-control" onkeyup="sum();" value="{{ 0 }}">
    <input type="hidden" id="kirim_painting" name="kirim_painting" class="form-control" onkeyup="sum();"
    ...
    <div class="col-md-4">
        ...
        <input type="text" id="no_kartu" name="no_kartu" value="{{ $kode }}" readonly class="form-control">
    </div>
    ...
    {{-- <div class="col-md-3">
        <label>Model</label> --}}
        <input type="hidden" id="model" name="model" value="{{ $d->model }}" class="form-control" readonly>
        {{--
    </div> --}}

    {{-- <div class="col-md-3">
        <label>Bagian</label> --}}
        <input type="hidden" id="bagian" name="bagian" value="{{ $d->bagian }}" class="form-control" readonly>
        {{--
    </div> --}}
    ...
    @if ($d->stok < $d->qty_trolly)
        <div class="col-md-4">
            ...
            <div class="input-group">
                <input type="text" id="stok" name="stok" value="{{ $d->stok }}" class="form-control bg-red" readonly>
                <div class="input-group-prepend">
                    <span class="input-group-text">Pcs </span>
                </div>
            </div>
        ...
        <div id="assy-panel" class="col-md-4" style="display:none">
            <label>Kirim Assy</label>
            <div class="input-group">
                <input type="text" id="kirim_assy" name="kirim_assy" class="form-control" value="{{ 0 }}"
                    onkeyup="sum();">
                <div class="input-group-prepend">
                    <span class="input-group-text">Pcs </span>
                </div>
        ...
        <div id="painting-panel" class="col-md-4" style="display:none">
            <label>Kirim Painting</label>
            <div class="input-group">
                <input type="text" id="kirim_painting" name="kirim_painting" class="form-control" value="{{ 0 }}"
                    onkeyup="sum();">
                <div class="input-group-prepend">
                    <span class="input-group-text">Pcs </span>
                </div>
        ...
        <div class="col-md-4">
            <label>Next Process</label>
            <input type="text" id="next_process" name="next_process" value="{{ $d->next_process }}" class="form-control"
                readonly>
        </div>
        @endif
