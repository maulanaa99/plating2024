                            ...
                            <div class="col-12 col-md-12 col-lg-12">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <label>Jam</label>
                                            <input type="time" id="waktu_kanban" name="waktu_kanban"
                                    ...
                                    <div class="col-md-12 mt-3 text-center">
                                        <span class="perhatian text-danger"> <i class="fa fa-danger"> "PASTIKAN BOX SESUAI
                                                DENGAN PARTNYA DAN BUKAN BOX KOSONG <br> DAN JUMLAHNYA HARUS FULL!!!"
                                            </i></span>
