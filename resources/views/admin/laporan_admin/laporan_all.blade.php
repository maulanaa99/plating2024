...
@section('title')
    Produksi {{ Carbon\Carbon::parse($start_date)->isoFormat('dddd, D MMMM Y') }} -
...
@section('content')
    <div class="card-header centering">
        <form action="{{ route('laporan.allAdmin') }}" method="GET">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-primary">
                    <div class="inner">
                        <h3>{{ number_format($sum_qty_bar, 0, '.', '.') }} Pcs</h3>
                        <p>
                ...
                <tbody>
                    @foreach ($alls as $all)
                        <tr>
                            ...
                            <td class="text-center">{{ $all->jenis }}</td>
                            {{-- <td style="width:1px; white-space:nowrap;"> --}}
